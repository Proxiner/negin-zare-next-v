        ...
        {/* <div className={styles.wrapper}> */}
            <div className={styles.cvContainer}>
                ...
                <div className={styles.logoContainer}>
                    <Image width={120} height={120} src='/assets/images/phone-logo.png' alt='logo' />
                </div>
                ...
                <div className={styles.textContainer}>
                    <div className={styles.titleAndStar}>
                        ...
                        <h1>
                            تو هم میتونی عضو تیم خفن ما بشی...
                        </h1>
                    </div>

                    <div className={styles.description}>
                        <p> برای اینکه عضو تیم ما بشی، کافیه رزومه خودتو بصورت PDF برای ما ارسال کنی.</p>
                    </div>

                    <div className={styles.formContainer}>
                        <form>
                            <label htmlFor="fullName"> نام و نام خانوادگی </label>
                            <input type="text" name='fullName' id='fullName' placeholder='نام کامل خود را وارد کنید' />

                            <label htmlFor='file'> بارگذاری فایل PDF </label>
                            <input type='file' id='file' className={styles.chooseFile} accept="application/pdf"  />
                ...
                <div className={styles.imageContainer}>
                    <div className={styles.imageCV}>
                        <Image width={430} height={550} src='/assets/images/intro_2.jpg' alt='model' />
                    </div>
                </div>
